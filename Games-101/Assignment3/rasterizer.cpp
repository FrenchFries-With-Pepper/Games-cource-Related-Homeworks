        ...
        for (int y = minY; y < maxY; y++)
        {
            ...
            if (insideTriangle(tempx, tempy, t.v))
            {
                ...
                if (z_interpolated < depth_buf[pixelIndex])
                {
                    ...
                    fragment_shader_payload payload(interpolated_color, interpolated_normal, interpolated_texcoords, texture ? &*texture : nullptr, bump ? &*bump : nullptr);
                    payload.view_pos = interpolated_shadingcoords;
                    auto pixel_color = fragment_shader(payload);
                    frame_buf[pixelIndex] = pixel_color;
                }
            }
        }
    }

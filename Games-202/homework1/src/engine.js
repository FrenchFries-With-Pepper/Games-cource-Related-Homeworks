...
function GAMES202Main() {
	...
	let lightUp = [0, 1, 0]
	const directionLight = new DirectionalLight(5000, [1, 1, 1], lightPos, focalPoint, lightUp, true, renderer.gl,0);
	renderer.addLight(directionLight);

	let lightPos2 =[0,80,-100];
	const directionLight2 = new DirectionalLight(5000, [1, 1, 1], lightPos2, focalPoint, lightUp, true, renderer.gl,1);
